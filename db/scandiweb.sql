...
(3, 'jacket-canada-goosee', 'https://cdn.shopify.com/s/files/1/0550/6241/0867/products/2_49e23e37-63e0-4db6-9a93-3b8bb96781df_720x.jpg?v=1644425382'),
(4, 'jacket-canada-goosee', 'https://cdn.shopify.com/s/files/1/0550/6241/0867/products/3_1a69fe4a-1939-47bc-84dc-34cbe1ab8c07_720x.jpg?v=1644425383'),
(5, 'ps-5', 'https://cdn.shopify.com/s/files/1/0550/6241/0867/products/ps5-digital-edition-01_720x.jpg?v=1649431544'),
(6, 'ps-5', 'https://cdn.shopify.com/s/files/1/0550/6241/0867/products/ps5-digital-edition-02_720x.jpg?v=1649431544'),
(7, 'xbox-series-s', 'https://cdn.shopify.com/s/files/1/0550/6241/0867/products/xbox-series-s-01_720x.jpg?v=1638460454'),
(8, 'xbox-series-s', 'https://cdn.shopify.com/s/files/1/0550/6241/0867/products/xbox-series-s-02_720x.jpg?v=1638460454');
...
INSERT INTO `prices` (`id`, `product_id`, `currency_label`, `amount`) VALUES
...
('xbox-series-s', 'Xbox Series S 512GB', 0, '<p>Hardware-beschleunigtes Raytracing macht dein Spiel noch realistischer Spiele Games mit bis zu 120 Bilder pro Sekunde...</p>', 3, 'Microsoft');
...
INSERT INTO `product_attribute_items` (`product_id`, `attribute_item_id`) VALUES
('ps-5', '1T'),
...
ALTER TABLE `product_attribute_items`
  ADD PRIMARY KEY (`product_id`,`attribute_item_id`),
...
--
ALTER TABLE `product_attribute_items`
  ADD CONSTRAINT `product_attribute_items_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
